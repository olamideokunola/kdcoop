...
public class CheckOutEvents {
    ...
    public static String finalizeOrderEntry(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (mode.equals("ship") || mode.equals("options")) {
        	//Custom line for checking shipping settings and paymentMethodType
        	methodType = request.getParameter("paymentMethodType");
        	Debug.logInfo("OLAMIDE_LOG_DEBUG: Current mode is " + mode,module);
        	Debug.logInfo("OLAMIDE_LOG_DEBUG: PAYMENT METHOD is " + methodType,module);
    ...
    public static String determineNextFinalizeStep(HttpServletRequest request, HttpServletResponse response) {
      ...
      //Custom DEbugging - Olamide Okunola
      	Debug.logInfo("OLAMIDE_LOG_DEBUG: processOrder item 4: " + processOrder[4],module);
      	Debug.logInfo("OLAMIDE_LOG_DEBUG: shippingOptionsSet: " + shippingOptionsSet,module);
